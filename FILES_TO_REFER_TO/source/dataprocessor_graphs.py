...
class LoadGraphs:
    ...
    def parse_all_data(self, load_path, num_node_attr, num_edge_attr, drop_dim_edge_timescalar): # "drop_dim_edge_timescalar" added @ 2023-07-06
        """
        ...
        for idx, filename in enumerate(dir_contents):
             ...
             # sanity check
             # Changed by JY @ 2023-02-16 to include also "subgraph"
            if '_sample_' not in filename.lower() and "subgraph" not in filename.lower():
                continue
