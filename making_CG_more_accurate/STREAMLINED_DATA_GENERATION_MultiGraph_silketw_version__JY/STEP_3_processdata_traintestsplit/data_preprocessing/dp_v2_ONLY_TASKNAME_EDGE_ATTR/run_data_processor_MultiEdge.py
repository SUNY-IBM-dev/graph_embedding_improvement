...
import sys
sys.path.append("/home/pwakodi1/tabby/STREAMLINED_DATA_GENERATION_MultiGraph_silketw_version/STEP_3_processdata_traintestsplit/data_preprocessing/dp_v2_ONLY_TASKNAME_EDGE_ATTR")
...
def run_data_processor(data_type : str, load_and_save_path: str):
    ...
    node_attribute_list = ['FileName',  'daddr', 'RelativeName'] # testing- remove FileName attribute
