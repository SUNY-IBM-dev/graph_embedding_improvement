...
def get_graph(csv_root, graph_root, file_edge_uid_list, net_edge_uid_list, proc_edge_uid_list, reg_edge_uid_list):
   ...
   # g1.es["Task"] = proc_event
    ...
    try:
        ...
        # JY @ 2024-1-1 : Is there a way to sorted order by timestamp when getting [<>,<>,..] when simplifying
        #                 check : https://igraph.org/python/doc/api/igraph._igraph.GraphBase.html#simplify
...
def first_step(idx, root_path):
   ...
   # EventTypes_to_Exclude_set = { x.lower() for x in EventTypes_to_Exclude_set }
    ...
    # JY @ 2024-1-1 : SimpleGraph instead of Multigraph
    get_graph(root_path, root_path, file_edge_uid_list, net_edge_uid_list, proc_edge_uid_list, reg_edge_uid_list)
