...
import sys
sys.path.append("/data/d1/jgwak1/tabby/graph_embedding_improvement_JY_git/graph_embedding_improvement_efforts/Trial_4__Local_N_gram__standard_message_passing/STREAMLINED_DATA_GENERATION_SimpleGraph_silketw_version__JY/STEP_3_processdata_traintestsplit/data_preprocessing/dp_v2_EDGE_ATTR_COMP_WITH_TASKNAME_NGRAM_SCHEME")
sys.path.append("/home/jgwak1/tabby/graph_embedding_improvement_JY_git/graph_embedding_improvement_efforts/Trial_4__Local_N_gram__standard_message_passing/STREAMLINED_DATA_GENERATION_SimpleGraph_silketw_version__JY/STEP_3_processdata_traintestsplit/data_preprocessing/dp_v2_EDGE_ATTR_COMP_WITH_TASKNAME_NGRAM_SCHEME")

# from data_processor_v2_MultiEdge import DataProcessor
from data_processor_v2_SimpleGraph_5BitNodeAttr_TasknameNgramCompEdgeAttr import DataProcessor

def process_all_graphs(data_type, 
                       load_path, 
                       save_path, 
                       data_proc, 
                       debug=False, 
