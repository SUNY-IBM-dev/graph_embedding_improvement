import os
from data_processor_v2__scalar_attrs_NOT_normalized import DataProcessor
...
def process_all_graphs(data_type, load_path, save_path, data_proc, debug=False, concat_events=True, compute_order=True):
    ...
    _save_path = save_path + "/Processed_Not_Normalized_" + data_type
...
node_attribute_list = ['FileName',  'daddr',
                     'RelativeName'] # testing- remove FileName attribute
