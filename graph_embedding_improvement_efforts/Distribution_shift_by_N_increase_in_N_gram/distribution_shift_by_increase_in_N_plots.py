...
if __name__ == "__main__":
   ...
   Baseline_Ngrams__Train_Full_Dataset_2_Tuning_csvpaths = {
      "Baseline_1gram": Baseline_1gram__Train_Full_Dataset_2_Tuning_csvpath,
      "Baseline_2gram": Baseline_2gram__Train_Full_Dataset_2_Tuning_csvpath,
      "Baseline_4gram": Baseline_4gram__Train_Full_Dataset_2_Tuning_csvpath,
   }

   Thread_Ngrams__Train_Full_Dataset_2_Tuning_csvpaths = {
      "Thread_1gram": Thread_1gram__Train_Full_Dataset_2_Tuning_csvpath,
      "Thread_2gram": Thread_2gram__Train_Full_Dataset_2_Tuning_csvpath,
      "Thread_4gram": Thread_4gram__Train_Full_Dataset_2_Tuning_csvpath,
   }
   ...
   # ----------------------------------------------- 
   # Set the following
   Ngram_approach_choice = Baseline_Ngrams__Train_Full_Dataset_2_Tuning_csvpaths
